...
[![x-cmd/install — kibi Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kibi.svg?lang=zh)](https://x-cmd.com/install/kibi)
...
- **Star**: 1,947 · **Fork**: 115 · **开放 issue**: 56 · **贡献者**: 28

## 累计统计

- **发布数**: 9 · **已合并 PR**: 483 · **开放 PR**: 12 · **已关闭 issue**: 40 · **开放 issue**: 16 · **提交数**: 542

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 2 | 6 | 0 | 1 | 5 |
| last60d | 2026-07-25 | 0 | 4 | 6 | 1 | 1 | 7 |
| 90d | 2026-06-25 | 0 | 9 | 6 | 1 | 1 | 13 |
| last180d | 2026-03-27 | 0 | 30 | 6 | 1 | 1 | 39 |
| 360d | 2025-09-28 | 4 | 153 | 10 | 14 | 5 | 172 |
| last720d | 2024-10-03 | 4 | 242 | 10 | 17 | 7 | 273 |
...
kibi 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `kibi` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kibi.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T02:56:29Z._
